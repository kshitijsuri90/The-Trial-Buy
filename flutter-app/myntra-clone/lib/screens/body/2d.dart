...
import 'package:flutter_myntra_clone/body_measurement/2d_request.dart';
...
class _TwoDState extends State<TwoD> {
  ...
  List<Widget> renderKeypoints(Size screen) {
    ...
    _recognitions.forEach((re) {
      print(re["keypoints"]);
      mh1=re["keypoints"][2]["y"]*factorY;
      ml1=re["keypoints"][16]["y"]*factorY;
      mw1=re["keypoints"][9]["x"]*factorX;
      mw2=re["keypoints"][10]["x"]*factorX;
    });
                          ...
                          Container(
                            ...
                            child: ButtonTheme(
                              child: PrimaryButton(
                                title: 'SUBMIT',
                                onPressed: () => {
                                  create2d(1152,864,imagebase64,context)
                                },
                              ),
                            ),
                          ),
